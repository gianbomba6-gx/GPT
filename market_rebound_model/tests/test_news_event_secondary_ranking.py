...
def test_lag_one_maps_friday_news_to_monday_session():
    rows = pd.DataFrame([
        {"Date": "2026-01-02", "symbol": "TSLA", "next_ret": -0.08, "v1_top20": True},  # Friday
        {"Date": "2026-01-05", "symbol": "TSLA", "next_ret": 0.04, "v1_top20": True},   # Monday
        {"Date": "2026-01-06", "symbol": "TSLA", "next_ret": -0.08, "v1_top20": True},  # Tuesday
        {"Date": "2026-02-02", "symbol": "TSLA", "next_ret": 0.02, "v1_top20": True},
    ])
    raw = pd.DataFrame([
        {"candidate_day": "2026-01-02", "published_at": "2026-01-03T01:00:00Z", "symbol": "TSLA", "headline": "product decline news", "url": "https://example.com", "summary": "product decline"},
        {"candidate_day": "2026-01-05", "published_at": "2026-01-05T15:00:00Z", "symbol": "TSLA", "headline": "routine company update", "url": "https://example.com", "summary": "routine company update"},
        {"candidate_day": "2026-01-06", "published_at": "2026-01-06T15:00:00Z", "symbol": "TSLA", "headline": "product decline news", "url": "https://example.com", "summary": "product decline"},
        {"candidate_day": "2026-02-02", "published_at": "2026-02-02T15:00:00Z", "symbol": "TSLA", "headline": "product decline news", "url": "https://example.com", "summary": "product decline"},
    ])
    lagged = score_oos(rows, raw=raw, min_n=2, shrink_k=0, event_lag_days=1)
    monday = lagged.loc[lagged["Date"].eq(pd.Timestamp("2026-01-05"))].iloc[0]
    assert monday["negative_event_product_share"] > 0
